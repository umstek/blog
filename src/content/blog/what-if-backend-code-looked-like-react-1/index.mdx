...
draftDatetime: 2022-09-19T14:30:00.000Z
pubDatetime: 2022-09-16T14:30:00.000Z
ogImage: "./cover.webp"
series:
  name: "What if backend code looked like React?"
  order: 1
tags:
  - jsx
  - react
...
⚠️  Deno requests net access to "0.0.0.0:8080". Run again with --allow-net to bypass this prompt.
...
Visit [http://localhost:8080/](http://localhost:8080/) and you'll see your browser agent.
...
![Kowalski, analysis](./Kowalski.webp)
